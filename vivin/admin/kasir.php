...
<header>
    <div class="navbar">
      <div class="navbar-brand" style="font-size: 40px;">Admin</div>
      <div>
      <a href="kasir.php" style="font-size:20px;">Riwayat Pemesanan</a>
      <a href="gudang/stokgudang.php" style="font-size:20px;">Stok Barang</a>  
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit.php?IdStruk=<?php echo $row["IdStruk"] ?>" class="edit-button">Edit</a>
              <a href="delete.php?IdStruk=<?php echo $row["IdStruk"] ?>" class="delete-button">Delete</a>
            </td>
          </tr>
        <?php
        }
